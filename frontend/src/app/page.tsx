      ...
      <li><a href="/">Trang chủ</a></li>
        ...
        <li className="dropdown">
          ...
          <ul className="dropdown-menu">
            <li><a href="#">Văn bản UBKT</a></li>
            <li><a href="#">Văn bản Trung Ương</a></li>
            <li><a href="#">Văn bản Địa phương</a></li>
          </ul>
        </li>
      ...
      <footer className="bg-dark text-white mt-10">
        <div className="container py-4 text-center">
          <h1 className="text-lg font-bold mb-2">
            ỦY BAN KIỂM TRA - LIÊN MINH HỢP TÁC XÃ VIỆT NAM
          </h1>
          <p>Địa chỉ: Số 6 Dương Đình Nghệ, phường Yên Hoà, quận Cầu Giấy, Tp Hà Nội</p>
          <p>Điện thoại: (+84)(80)49711</p>
          <p className="mt-4">
            Thiết kế bởi Viện Khoa học công nghệ và Môi trường
          </p>
        </div>
